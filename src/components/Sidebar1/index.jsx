...
export default function Sidebar1({ ...props }) {
  ...
  return (
    ...
    >
      <Img src="images/img_sidebar_logo.png" alt="sidebarlogo" className="h-[40px] w-[161px] object-contain" />
      <Menu
        menuItemStyles={{
          button: {
            padding: "17px",
      ...
      >
        <MenuItem component={<Link to="/"/>}  icon={<Img src="images/img_home.svg" alt="home" className="h-[25px] w-[25px]" />}>Dashboard</MenuItem>
        <MenuItem  component={<Link to="/transaction"/>} icon={<Img src="images/img_television.svg" alt="television" className="h-[25px] w-[25px]" />}>
          Transactions
        </MenuItem>
